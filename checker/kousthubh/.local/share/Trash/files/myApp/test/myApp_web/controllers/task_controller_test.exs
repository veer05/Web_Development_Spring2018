defmodule MyAppWeb.TaskControllerTest do
  ...
  @create_attrs %{done: true, done_time: ~T[14:00:00.000000], task_body: "some task_body", task_title: "some task_title"}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated task_body"
    end
